// Link: https://www.codingninjas.com/studio/problems/right-view_764605?leftPanelTab=0
/*
you have a BTree, You are looking from the right, Print all the Nodes you can see..
    NOTE: Only Last Node at every level can be seen from right View.
*/
...
Logic: Use LEvel order Traversal,
    ...
    -- Map<lvl, NodeValue> -> Push in Map when a lvl comes. [**IMP**]
...
Appraoch2 : [Use Recrsion] [faster than level Order Traversal]
    ...
    -- look for right and left child. [right first as now the level direction is reversed]
    [**Done**]
*/